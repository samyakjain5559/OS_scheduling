     ...
     while(newhead != NULL){  // inverting the Linked list
        ...
        //}
            if(nextnode->task->burst > 10){  // this
               ...
               //printf("procccount = %d\n",procccount);
               if(procccount > 0){
                 n[count] = waittime-(procccount*10)-nextnode->task->burst;  // this
               }else{
